...
import com.mobilewizards.logging_app.databinding.ActivitySettingsOldBinding

class SettingsActivityOld : Activity() {
    private lateinit var binding: ActivitySettingsOldBinding

    @SuppressLint("ClickableViewAccessibility")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivitySettingsOldBinding.inflate(layoutInflater)
